...
unsigned int* pStackBase[NTASKS];
...
int main(void)
{
  ...
  TaskFunctions[0] = Opravilo1;
  TaskFunctions[1] = Opravilo2;
  TaskFunctions[2] = Opravilo3;
  TaskFunctions[3] = Opravilo4;



  //InitializeTasks((unsigned int*)stackRegion, TCB, TaskFunctions);

  InicializrajOpravila((unsigned int*)stackRegion, TCB, TaskFunctions);
